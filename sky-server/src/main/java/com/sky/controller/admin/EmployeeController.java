...
public class EmployeeController {
    ...
    @GetMapping("test")
    @ApiOperation("员工查询")
    public Map queryEmployee(EmployeePageQueryDTO employeePageQueryDTO) {
        log.info("员工查询，参数为：{}", employeePageQueryDTO);
        Map map = employeeService.query(employeePageQueryDTO);
        return map;
    }
